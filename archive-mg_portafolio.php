...
// Obtener todas las industrias para el filtro (los portafolios heredan industria del cliente)
$args_industrias = [
...
<main class="container py-5">
    ...
    <header class="mb-5" style="padding-top: 10vh;">
        <?php if ($is_taxonomy): ?>
            <h1 class="display-4 mb-3">
                <?= esc_html(sprintf(__('Portafolio en %s', 'maggiore'), $current_term->name)); ?>
            </h1>
    ...
    <?php if (!empty($industrias) && !$is_taxonomy): ?>
        <section class="mb-5">
            <div class="d-flex flex-wrap gap-2 align-items-center">
                ...
                <a href="<?= get_post_type_archive_link('mg_portafolio'); ?>" 
    ...
    <?php else: ?>
        ...
        <div class="alert alert-info text-center py-5">
            ...
            <p class="mb-0">
                <?php _e('Actualmente no hay proyectos publicados en esta sección.', 'maggiore'); ?>
            </p>
        </div>
    <?php endif; ?>
