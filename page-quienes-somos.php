...
<main>
    ...
    <section class=" separador container-fluid mt-5 pt-5">
            ...
            ?>
                    ...
                    <div class="row g-2 mb-2 align-items-stretch <?= $is_even ? 'justify-content-start' : 'justify-content-end'; ?>">
                        ...
                        <!-- Card de Equipo -->
                        <div class="col-12 col-xxl-2 col-xl-3 col-lg-3 text-center  <?= $is_even ? 'order-1 order-lg-1' : 'order-1 order-lg-2'; ?>" >
                        ...
                        <div class="col-12 col-xxl-9 col-xl-9 col-lg-9  <?= $is_even ? 'order-2 order-lg-2' : 'order-2 order-lg-1'; ?>" style="max-width:1300px">
                            <div class="card-mg h-100 <?= $is_even ? 'text-start' : 'text-lg-end'; ?>  d-flex flex-column justify-content-center" >
            ...
            ?>
                <div class="container-fluid  py-2  "  >
                    <div class="row card-mg  p-2 pb-2 pt-0 g-2 gx-5 align-items-start justify-content-between ">
                        ...
                        <div class="p-3 pt-5" >
                                <h3 class="mb-4 display-6"><?= esc_html($area_titulo); ?></h3>
                        ...
                        <div class="col-12 col-xxl-8  col-xl-6 p-0"  >
                            <div class="row  g-2 justify-content-xl-end">
                                ...
                                foreach ($miembros as $post):
                                    setup_postdata($post);
                                ?>
                                    <div class="col-xxl col-xl-4 col-md-3 col-6 col-xxs-12  alternative-grid" style="" >
        ...
        <div class="row g-2 mb-2">
            <div class="col-lg-7">
                <article class="mb-5" style="height: 100%;">
                    ...
                    <p class=" h3 display-5" style="line-height: 1;">
    ...
    <!-- VALORES DE MARCA -->
    <section class=" separador container-fluid mt-5 pt-5 mb-5 mg_values_scope">
        <div class="feature-name-2 mb-3 mx-auto text-center">
            <h2 ><?php _e('Valores de Marca', 'maggiore'); ?></h2>
        </div>
            <div>
                            <h3 class="display-2 text-center mb-5"><?php _e('En Maggiore <br> <span class="mg_values_letter">C</span><span class="mg_values_letter">A</span><span class="mg_values_letter">D</span><span class="mg_values_letter">A</span> paso importa', 'maggiore'); ?></h3>

            </div>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-2">
            <!-- Consistencia -->
            <div class="col">
                <article class="card-mg mg_values_card" style="height: 100%">
